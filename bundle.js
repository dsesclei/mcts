...
/******/ 	var hotCurrentHash = "cdfc239728e4c1c68b26"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Worker = __webpack_require__(231);

	var game = 'go';

	function handleHumanMove(row, col) {
	  if (!ready) return;
	  worker.postMessage({ type: 'move', row: row, col: col });
	  ready = false;
	}

	function renderGame(board, playerToMove, isGameOver) {
	  var isThinking = playerToMove === computerPlayer;
	  var gameBoard = _react2['default'].createElement(_board2['default'], {
	    board: board,
	    game: game,
	    isGameOver: isGameOver,
	    isThinking: isThinking,
	    onMove: handleHumanMove });
	  _react2['default'].render(gameBoard, document.getElementById('content'));
	}
	...
	worker.postMessage({ type: 'startGame', game: game, humanPlayer: humanPlayer });

	/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(228); if (makeExportsHot(module, __webpack_require__(123))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "app.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Board = (function (_React$Component) {
	  ...
	  _createClass(Board, [{
	    ...
	    key: 'renderCell',
	    value: function renderCell(rowNum, value, cellNum) {
	    ...
	    value: function renderRow(row, rowNum) {
	      return _react2['default'].createElement(
	        'div',
	        { className: 'board-row', key: rowNum },
	...
	Board.propTypes = {
	  ...
	  game: _react2['default'].PropTypes.string.isRequired,
	  isGameOver: _react2['default'].PropTypes.bool.isRequired,
	  isThinking: _react2['default'].PropTypes.bool.isRequired,
	  onMove: _react2['default'].PropTypes.func.isRequired
	};
	module.exports = exports['default'];

	/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(228); if (makeExportsHot(module, __webpack_require__(123))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "board.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(33)(module)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(228); if (makeExportsHot(module, __webpack_require__(123))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "cell.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(33)(module)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(true) {
		...
		if(!content.locals) {
			module.hot.accept(233, function() {
				var newContent = __webpack_require__(233);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "body {\n  background-color: #555959;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  font-weight: 600;\n}\n@-webkit-keyframes glow-green {\n  to {\n    border-color: #00ff88;\n  }\n}\n@-webkit-keyframes glow-blue {\n  to {\n    border-color: #00c8ff;\n  }\n}\n.board-container.go .board-row .board-cell {\n  color: #8ceaff;\n  font-size: 46px;\n  width: 50px;\n  height: 50px;\n  border-right: 1px solid #8ceaff;\n}\n.board-container.go .board-row:not(:first-child) {\n  border-top: 1px solid #8ceaff;\n}\n.board-container.go.thinking .board-row {\n  -webkit-animation: glow-blue 0.5s infinite alternate;\n}\n.board-container.go.thinking .board-row .board-cell {\n  -webkit-animation: glow-blue 0.5s infinite alternate;\n}\n.board-container.tic-tac-toe .board-row .board-cell {\n  color: #b8ffde;\n  font-size: 72px;\n  width: 150px;\n  height: 150px;\n  border-right: 1px solid #b8ffde;\n}\n.board-container.tic-tac-toe .board-row:not(:first-child) {\n  border-top: 1px solid #b8ffde;\n}\n.board-container {\n  display: flex;\n  flex-direction: column;\n}\n.board-container .board-row {\n  display: flex;\n  width: 450px;\n}\n.board-container .board-row .board-cell {\n  cursor: default;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  font-family: 'Arial';\n}\n.board-container .board-row .board-cell:last-child {\n  border-right: none;\n}\n.board-container .board-row .board-cell.clickable {\n  cursor: pointer;\n}\n.board-container.game-over .board-row .board-cell.clickable {\n  cursor: default;\n}\n", ""]);
